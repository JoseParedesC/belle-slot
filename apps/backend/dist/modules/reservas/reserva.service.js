...
async function crearReserva(input) {
    const { cliente, servicioId, disenoId, fecha, horaInicio, empresaId } = input;
    ...
    const disponibles = await (0, disponibilidad_service_1.calcularDisponibilidad)(fecha, servicioId, resolvedEmpresaId || undefined);
    ...
    const clienteRegistrado = await (0, cliente_controller_1.buscarOCrearCliente)(cliente, resolvedEmpresaId || undefined);
